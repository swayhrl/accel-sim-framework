...
`run_integrated_pressure.sh` runs compact, trace-driven P1--P3 cases against
...
Run the legacy P1--P3 batch, after building the core and frontend:

```bash
tests/l2_char/run_integrated_pressure.sh --out /tmp/l2-char-pressure
```

Use the dedicated P4/P5/P6 scripts below for closeout evidence.  Each result
directory contains raw logs, resolved overlays, and `summary.tsv`; none is a
workload-characterization campaign.
