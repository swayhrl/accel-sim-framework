...
All rows start in `trace_needed`.  A trace collection run must:
...
The public V100 archive endpoint was checked on 2026-08-14 and did not expose
separate DeepBench, CUDA Tensor-Core GEMM, or SHOC trace archives.  Therefore
this queue does not download a guessed archive or start an invalid replay.
