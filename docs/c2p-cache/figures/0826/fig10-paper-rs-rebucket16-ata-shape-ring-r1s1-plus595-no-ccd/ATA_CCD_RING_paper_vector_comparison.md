...
| LU | R1S1 | 1.058 | 0.801 | -0.257 | 1.032 | 1.000 | -0.031 | 1.087 | 1.187 | +0.099 |
| SG | R1S1 | 1.039 | 0.800 | -0.239 | 1.013 | 0.993 | -0.020 | 1.301 | 1.018 | -0.282 |
| 3M | R1S1 | 0.401 | 0.808 | +0.408 | 1.024 | 1.007 | -0.017 | 1.206 | 0.996 | -0.210 |
| GE | R1S1 | 0.474 | 0.806 | +0.332 | 1.050 | 1.002 | -0.049 | 1.298 | 0.998 | -0.300 |
| B+ | R1S1 | 0.757 | 0.796 | +0.038 | 1.045 | 1.001 | -0.044 | 1.075 | 1.015 | -0.059 |
| 2D | R1S1 | 0.282 | 0.794 | +0.512 | 1.004 | 0.998 | -0.005 | 0.985 | 1.013 | +0.028 |
| ST | R1S1 | 1.060 | 0.816 | -0.244 | 1.000 | 1.000 | -0.001 | 0.759 | 1.105 | +0.346 |

## Largest visual deltas

- **ATA:** 2D +0.512, 3M +0.408, GE +0.332, GS +0.315.
- **CCD:** BI +0.081, GA -0.052, GE -0.049, GS -0.048.
- **RING:** HO -0.375, ST +0.346, DW -0.304, GE -0.300.
