...
| AT | R0S1 | 0.590 | 0.678 | +0.088 | 1.029 | 1.017 | -0.012 | 0.773 | 0.833 | +0.060 |
| BI | R0S1 | 0.555 | 0.679 | +0.124 | 0.964 | 1.046 | +0.081 | 0.784 | 0.819 | +0.035 |
| GS | R0S1 | 0.349 | 0.664 | +0.315 | 1.035 | 0.987 | -0.048 | 0.889 | 0.903 | +0.013 |
| LU | R1S1 | 1.058 | 0.801 | -0.257 | 1.032 | 1.000 | -0.031 | 1.087 | 1.079 | -0.008 |
| SG | R1S1 | 1.039 | 0.800 | -0.239 | 1.013 | 0.993 | -0.020 | 1.301 | 0.926 | -0.375 |
| 3M | R1S1 | 0.401 | 0.808 | +0.408 | 1.024 | 1.007 | -0.017 | 1.206 | 0.905 | -0.300 |
| GE | R1S1 | 0.474 | 0.806 | +0.332 | 1.050 | 1.002 | -0.049 | 1.298 | 0.907 | -0.391 |
| B+ | R1S1 | 0.757 | 0.796 | +0.038 | 1.045 | 1.001 | -0.044 | 1.075 | 0.923 | -0.152 |
| 2D | R1S1 | 0.282 | 0.794 | +0.512 | 1.004 | 0.998 | -0.005 | 0.985 | 0.921 | -0.064 |
| ST | R1S1 | 1.060 | 0.816 | -0.244 | 1.000 | 1.000 | -0.001 | 0.759 | 1.005 | +0.246 |

## Largest visual deltas

- **ATA:** 2D +0.512, 3M +0.408, GE +0.332, GS +0.315.
- **CCD:** BI +0.081, GA -0.052, GE -0.049, GS -0.048.
- **RING:** GE -0.391, SG -0.375, HO -0.375, DW -0.304.
