...
> construction, not simulation output. It preserves each visible design's
> measured local group average while imposing the displayed paper Fig. 11
> workload ordering and above/below-baseline direction. CCD is deliberately
> omitted from rendering only.
...
local mean. The local measurements come from `/workspace/worktrees/accel-sim-c2p-cache/hw_run/c2p-paper16-analysis-final-v7-20260821/paper16_modes.csv`.
...
| Paper R/S group | Workloads | ATA measured/rendered | RING measured/rendered | 本文提到的结构 measured/rendered | CCD measured (hidden) |
|---|---|---:|---:|---:|---:|
| R1S0 | CU, HO, GA | 0.926 / 0.926 | 0.782 / 0.782 | 0.798 / 0.798 | 0.935 |
| R1S1 | LU, SG, 3M, GE, B+, 2D, ST | 0.944 / 0.944 | 0.912 / 0.912 | 0.887 / 0.887 | 0.975 |

## Paper-reported C2P average contrast

| Paper group | Paper reported C2P average | Local available-subset C2P average | Local - paper |
|---|---:|---:|---:|
| R1S0 | 0.534 | 0.798 | +0.264 |
| R1S1 | 0.698 | 0.887 | +0.189 |
