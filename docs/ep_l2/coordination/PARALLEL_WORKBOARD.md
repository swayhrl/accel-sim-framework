...
| L1-D512-BANK | Interaction | L1 bank headroom after descriptor relief | D512 + banks 4->8 only | same 7 | D512 preflight/pass | TODO | — | isolated factorial result root | PENDING | Detects L1 bank bottleneck after descriptor relief. |
