...
7. `STAGE_ACCEPTANCE_MATRIX.md`
8. `PARALLEL_EXECUTION_AND_AUTONOMOUS_RECOVERY.md`
9. `ACCEPTANCE_AND_REVIEW_REQUIREMENTS.md`
10. `CODEX_NEXT_STAGE_174NEW_SIMULATION_FOUNDATION.md`

For a new Codex window, `GOAL_ACTIVATION_174NEW.md` is the concise activation entry point.
