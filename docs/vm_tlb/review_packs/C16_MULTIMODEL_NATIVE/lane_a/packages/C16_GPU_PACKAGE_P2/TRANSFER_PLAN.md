# C16_GPU_PACKAGE_P2 transfer plan

This immutable rolling package is limited to `c16_qwen25_7b_raw_reference`. It contains no `.incomplete`, `.curl.download`, remote-only, live-worktree, GPU, profiler, NVBit, simulator, SASS, or full-ROI artifact.
