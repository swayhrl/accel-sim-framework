# C16_GPU_PACKAGE_P0 transfer plan

This immutable rolling package is limited to `c16_llama32_1b_frozen_compatible`. It contains no `.incomplete`, `.curl.download`, remote-only, live-worktree, GPU, profiler, NVBit, simulator, SASS, or full-ROI artifact.
