...
C input: manifest-validated committed selector `4fd34b1837ab6e23832c9ab1f215869c9185f68a`; it is offline-only and not a capture authorization. `CONSUMED_INPUTS.tsv` records the exact manifest hash.
