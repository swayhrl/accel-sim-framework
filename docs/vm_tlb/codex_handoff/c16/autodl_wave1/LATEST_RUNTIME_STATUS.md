...
| Qwen2.5-0.5B P1 | PASS (`67dea9e7-29f9-488a-b70d-e345508f3f79`) | PASS: S1, S2, and S3/TEXT (`a67d9a5e-049a-401f-bdbe-6281e89b7351`) | Pending fixed target | Pending fixed target | S3 baseline and full-range G1 passed independent CUDA/correlation/NVTX export validation; raw `.nsys-rep` is hash-closed in `RAW_ARTIFACT_INDEX.tsv`. |
