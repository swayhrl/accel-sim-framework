...
Status: **ACTIVE — 5/12 Base rows accepted; NN/Base, LUD/Base, and Hotspot1/Base strict-valid pending stage acceptance; 2DConvolution/Gaussian/MRI-Q Base active; Btree queued**
