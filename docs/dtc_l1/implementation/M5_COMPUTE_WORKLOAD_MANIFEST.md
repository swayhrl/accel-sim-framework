...
| remaining seven | `ACTIVE_FORMAL_BASE_16KB` | Corrected isolated Base runs for ATAX, GEMVER, MVT, SYRK, SYR2K, 2MM, and Conv2D are active; no output claim is made before source self-check and strict invariant parsing complete. |
