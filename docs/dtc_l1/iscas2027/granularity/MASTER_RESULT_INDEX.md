...
4-to-8 resource gate remains `HOLD_AT_4` because exact available memory is
below the 25% threshold. Every pre-existing attempt is preserved.
...
| SG1 | `hrl/iscas2027-dtc-sg1-wholeline-controls-v0` | Smoke 6/6 passes; BICG/Btree are exact-identity G6 reuse; GESUMMV/ATAX x B16-N/TC80-N are active under a persistent controller | Immutable attempt evidence on SG1 branch |
