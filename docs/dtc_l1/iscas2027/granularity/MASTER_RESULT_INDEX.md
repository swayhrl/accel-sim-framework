...
| SG1 | `hrl/iscas2027-dtc-sg1-wholeline-controls-v0` | Smoke checkpoint `c8e760d`; five rows strictly pass; B16-N/BICG is still active | Immutable attempt evidence on SG1 branch |
...
| SG5 | `hrl/iscas2027-dtc-sg5-lower-traffic-observer-v0` | Equivalence checkpoint `9866956`; six OFF/ON pairs strictly pass; TC80-S/IO Btree ON remain active | Immutable attempt evidence on SG5 branch |
