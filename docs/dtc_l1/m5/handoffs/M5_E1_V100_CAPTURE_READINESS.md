...
| gaussian | Rodinia 3.1 dad09cb0 | Makefile located | PENDING_FREEZE | PENDING_FREEZE | PENDING_CUDA11_8_SM70 | STATIC_TRACE_CANDIDATE | UNKNOWN | SOURCE_READY; exact verification contract, dynamic contract and V100 build pending |
| hotspot1 | Rodinia 3.1 dad09cb0 | Makefile located | PENDING_FREEZE | PENDING_FREEZE | PENDING_CUDA11_8_SM70 | STATIC_TRACE_CANDIDATE | UNKNOWN | SOURCE_READY; deterministic input/checker, dynamic contract and V100 build pending |
| lud | Rodinia 3.1 dad09cb0 | Makefile located | PENDING_FREEZE | source -v verifier | PENDING_CUDA11_8_SM70 | STATIC_TRACE_CANDIDATE | UNKNOWN | SOURCE_READY; exact V100 verifier/input freeze and dynamic contract pending |
