...
A low-frequency host-only `monitor_fast64_1_r2_autorefiller.sh` is prepared for
that exact continuation under a persistent controller: it holds a separate monitor lock, pins the reviewed
