...
python3 -m venv "$bundle/toolchain/venv"; "$bundle/toolchain/venv/bin/pip" install --no-index --find-links "$bundle/cache/wheelhouse" -r "$root/offline/python-requirements.lock"
