...
export C2P_PPA_RTL_FILES="$script_dir/rtl/c2p_snapshot_store.v $script_dir/rtl/c2p_bf_engine.v $script_dir/rtl/c2p_snapshot_matrix.v $script_dir/rtl/c2p_query_engine.v $script_dir/rtl/c2p_cache_rtl.v $C2P_SNAPSHOT_MACRO_VERILOG"
