...
r=Path('/data/c16/deepseek_v26');out={}
for k,db,name in [('in_context',r/'qk_incontext.sqlite','C16_V26_MIXED_PERSISTENT_QK_INCONTEXT'),('replay',r/'qk_replay.sqlite','C16_V26_MIXED_PERSISTENT_QK_REPLAY')]:
...
out['equivalent']=out['in_context']==out['replay'];(r/'QK_SIGNATURE.json').write_text(json.dumps(out,indent=2,sort_keys=True)+'\n');print(json.dumps(out,indent=2,sort_keys=True))
