...
def write_stage_status(output_root: Path) -> None:
    ...
    status = {
        ...
        "C16-0.3": ("CONSUMED_FIXED_G_RELEASE", "OFFLINE_READY_NOT_GPU_EXECUTED", "G@b5039e160331db993e226bc02fcdfa811db29911; manifest=97b54c7c", "NA", "offline environment closure only; no GPU instance or wheel import receipt exists"),
        "C16-0.4": ("CONSUMED_FIXED_G_RELEASE", "OFFLINE_READY_NOT_GPU_EXECUTED", "G@b5039e160331db993e226bc02fcdfa811db29911; manifest=97b54c7c", "NA", "runner/wrapper fixtures only; no GPU runner execution exists"),
        ...
        "C16-0.8": ("PARTIAL_RELEASE_C_ONLY", "OFFLINE_FIXTURE_VALIDATED_C_ONLY", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "H fixed commit lacks a publish manifest, so H data is not consumed"),
        "C16-0.9": ("WAITING_INPUT", "NOT_EXECUTED", "C16_GPU_PACKAGE_READINESS.md;TRANSFER_PREREQUISITES.tsv", "NA", "G 0.3/0.4 and C 0.8 are hash-bound; H 0.8 lacks a manifest, so package is intentionally unpublished"),
        "C16-3.1": ("CONSUMED_FIXED_C_RELEASE", "OFFLINE_SCHEMA_VALIDATED", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "strata release is not a native fact table"),
        "C16-3.2": ("CONSUMED_FIXED_C_RELEASE", "OFFLINE_SELECTOR_VALIDATED", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "no candidate outcome used; target application waits for G catalog"),
        "C16-3.3": ("CONSUMED_FIXED_C_RELEASE", "OFFLINE_ESTIMATOR_VALIDATED", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "fixture conservation does not qualify a native metric"),
        "C16-3.4": ("CONSUMED_FIXED_C_RELEASE", "OFFLINE_BUDGET_VALIDATED", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "capture cost fields are not observed provider costs"),
        "C16-3.5": ("CONSUMED_FIXED_C_RELEASE", "RETROSPECTIVE_ORACLE_CALIBRATION", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "C12/C13 mode=0 only; no blind or native claim"),
        "C16-3.6": ("CONSUMED_PROTOCOL_WAITING_G", "PENDING", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "requires committed Wave-1 catalog"),
        "C16-4.2": ("CONSUMED_PROTOCOL_WAITING_G", "PENDING", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "no native target identity exists"),
        ...
        "C16-6.1": ("CONSUMED_FIXED_C_RELEASE", "METRIC_BY_METRIC_BOUNDARY_PUBLISHED", "C@fed28d8113c0d92cf3a576645f5d736769aefb12; manifest=20b94eef", "NA", "no global sampler PASS and no native metric qualification"),
