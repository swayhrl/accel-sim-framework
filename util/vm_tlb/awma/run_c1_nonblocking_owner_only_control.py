...
DURABLE = Path('/root/share/mnt164/huangrulin/awma_c1_nonblocking_sharing_causal_ablation_v1/raw')
...
def run_point(target: str, timeout: int, overwrite: bool) -> dict[str, object]:
    name = f'{target}_OWNER_ONLY_NO_SHARE_10_80'
    ...
    env['GPGPUSIM_AWMA_NONBLOCKING_CAUSAL_ABLATION'] = \
        'owner_only_no_share'
    ...
    receipt = {
        ...
        'target': target, 'candidate': 'NONBLOCKING_OWNER_ONLY_NO_SHARE_CONTROL',
...
def main() -> int:
    ...
    targets = ('T0', 'T1', 'T2', 'SPLITKV', 'COMBINE')
