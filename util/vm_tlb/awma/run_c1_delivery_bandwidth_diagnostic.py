...
def run_point(target: str, timeout: int, overwrite: bool) -> dict[str, object]:
    name = f'{target}_C1_SLOTS2_10_80'
    ...
    env['GPGPUSIM_AWMA_SHARE_DELIVERY_SLOTS'] = '2'
    ...
    receipt = {
        ...
        'target': target, 'candidate': 'same_page_share',
        'delivery_slots': 2, 'vm_config': '10/80', 'argv': cmd,
...
def main() -> int:
    ...
    targets = ('A1',) if args.matrix == 'smoke' else ('T0', 'T2')
