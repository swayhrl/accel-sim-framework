...
def run_point(target: str, timeout: int, overwrite: bool) -> dict[str, object]:
    name = f'{target}_C1_FANOUT4_10_80'
    ...
    env['GPGPUSIM_AWMA_SHARE_MIN_COHORT_SIZE'] = '4'
    ...
    receipt = {
        ...
        'target': target, 'candidate': 'C1_FANOUT4',
        'min_cohort_size': 4, 'delivery_slots': 1, 'vm_config': '10/80',
        'argv': cmd,
...
def main() -> int:
    ...
    parser.add_argument('matrix', choices=('smoke', 'ai'))
    parser.add_argument('--workers', type=int, default=3)
    parser.add_argument('--timeout-seconds', type=int, default=21600)
    parser.add_argument('--overwrite', action='store_true')
    args = parser.parse_args()
    targets = ('A1',) if args.matrix == 'smoke' else ('T0', 'T1', 'T2')
