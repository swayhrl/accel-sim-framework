...
REPO = Path('/root/workspace/accel-sim-framework-awma-rtx4080-v1-ideal-translation-control-v3')
RUNTIME = Path('/root/awma_rtx4080_v1_ideal_translation_control_v3_runtime')
...
def main() -> int:
    ...
    ap.add_argument('--targets', nargs='+', choices=('T0', 'T1', 'T2'),
                    default=('T0', 'T1', 'T2'))
    args = ap.parse_args()
