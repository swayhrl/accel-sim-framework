...
REPO = Path('/root/workspace/accel-sim-framework-awma-rtx4080-v1-ideal-translation-control-v2')
RUNTIME = Path('/root/awma_rtx4080_v1_ideal_translation_control_v2_runtime')
