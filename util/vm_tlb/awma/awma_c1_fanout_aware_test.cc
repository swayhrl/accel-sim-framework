...
int main() {
  ...
  assert(vm_translation::awma_share_delivery_slots() == 1);
  unsetenv("GPGPUSIM_AWMA_SHARE_DELIVERY_SLOTS");
  unsetenv("GPGPUSIM_AWMA_SHARE_MIN_COHORT_SIZE");
  assert(vm_translation::awma_share_min_cohort_size() == 2);
  setenv("GPGPUSIM_AWMA_SHARE_MIN_COHORT_SIZE", "4", 1);
  assert(vm_translation::awma_share_min_cohort_size() == 4);
  setenv("GPGPUSIM_AWMA_SHARE_MIN_COHORT_SIZE", "2", 1);
  assert(vm_translation::awma_share_min_cohort_size() == 2);
  unsetenv("GPGPUSIM_AWMA_SHARE_MIN_COHORT_SIZE");
