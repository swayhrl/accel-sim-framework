...
TARGETS = {
    'H1': {
        ...
        'target_id': 'C1_REPLACEMENT', 'producer_global_navigation': 16795,
    ...
    'H2': {
        ...
        'target_id': 'C2_REPLACEMENT', 'producer_global_navigation': 101035,
...
def validate_input(target: str) -> tuple[Path, str, dict[str, object]]:
    ...
    expected = {
        'scientific_target_id': 'STR_8a5773a1d265',
        'scenario': spec['scenario'], 'decode_step': spec['decode_step'],
        'phase': 'DECODE', 'grid': '224,1,1', 'block': '32,4,1',
        'accepted_recurrence': 'STABLE_48',
