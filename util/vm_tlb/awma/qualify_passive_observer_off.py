...
OUTPUT = RUNTIME / 'observer_off_neutrality.json'
EXPECTED = {
...
def qualify(target: str) -> dict[str, object]:
    directory = DURABLE / f'{target}_OBSERVER_OFF_10_80'
    ...
    gates = {
        ...
        'other_observer_off':
            env.get('GPGPUSIM_AWMA_BOTTLENECK_OBSERVATORY') == '0',
...
def main() -> int:
    ...
    receipt = {
        'stage': STAGE,
        'phase': 'INSTRUMENTATION_OFF_NEUTRALITY',
