...
with tempfile.TemporaryDirectory() as d:
    ...
    # A byte-identical terminal print is deterministically deduplicated.  A
    # non-identical repeat cannot be assigned an epoch and fails closed.
    log.write_text("".join(base.format(slice=i) for i in range(64)) + "".join(base.format(slice=i) for i in range(64)))
