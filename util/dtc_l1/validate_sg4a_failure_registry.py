...
def main() -> None:
    ...
    for row in registry:
        ...
        names = {"manifest_sha256": "RUN_MANIFEST.tsv", "start_sha256": "RUN_START.tsv",
                 "terminal_sha256": "RUN_TERMINAL.tsv", "stdout_sha256": "simulator.stdout",
    ...
    print(f"SG4A preserved failure registry: PASS ({len(registry)} immutable nonaccepted Core95 deadlocks)")
