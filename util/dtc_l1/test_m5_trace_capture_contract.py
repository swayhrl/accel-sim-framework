...
assert '"TRACE_FILE_COMPRESS":"0"' in text and 'kernelslist_ctx_*' in text and '"--text"' in text
assert 'skipinitialspace=True' in text and 'ambiguous resumable capture attempts' in text
assert 'ordered replay memcpy mapping mismatch' in text
assert 'resumable capture failed immutable bundle validation' in text
